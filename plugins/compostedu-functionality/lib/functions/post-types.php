...
// Register Custom Post Type
function thirty_party_resource_post_type() {

	$labels = array(
		'name'                  => _x( 'Thirty Party Resources', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Thirty Party Resource', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Thirty Party Resources', 'text_domain' ),
		'name_admin_bar'        => __( 'Thirty Party Resource', 'text_domain' ),
		'archives'              => __( 'Thirty Party Resource Archives', 'text_domain' ),
		'attributes'            => __( 'Thirty Party Resource Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Thirty Party Resource:', 'text_domain' ),
		'all_items'             => __( 'All Thirty Party Resources', 'text_domain' ),
		'add_new_item'          => __( 'Add New Thirty Party Resource', 'text_domain' ),
		'add_new'               => __( 'New Thirty Party Resource', 'text_domain' ),
		'new_item'              => __( 'New Thirty Party Resource', 'text_domain' ),
		'edit_item'             => __( 'Edit Thirty Party Resource', 'text_domain' ),
		'update_item'           => __( 'Update Thirty Party Resource', 'text_domain' ),
		'view_item'             => __( 'View Thirty Party Resource', 'text_domain' ),
		'view_items'            => __( 'View Thirty Party Resources', 'text_domain' ),
		'search_items'          => __( 'Search Thirty Party Resources', 'text_domain' ),
		'not_found'             => __( 'No Thirty Party Resources found', 'text_domain' ),
		'not_found_in_trash'    => __( 'No Thirty Party Resources found in Trash', 'text_domain' ),
		'featured_image'        => __( 'Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
		'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
		'use_featured_image'    => __( 'Use as featured image', 'text_domain' ),
		'insert_into_item'      => __( 'Insert into Thirty Party Resource', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Thirty Party Resource', 'text_domain' ),
		'items_list'            => __( 'Thirty Party Resources list', 'text_domain' ),
		'items_list_navigation' => __( 'Thirty Party Resources list navigation', 'text_domain' ),
		'filter_items_list'     => __( 'Filter Thirty Party Resources list', 'text_domain' ),
	);
	$args = array(
		'label'                 => __( 'Thirty Party Resource', 'text_domain' ),
		'description'           => __( 'Thirty Party Resource information pages.', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'custom-fields' ),
		'hierarchical'          => false,
		'public'                => true,
...
add_action( 'init', 'thirty_party_resource_post_type', 0 );
...
function people_post_type() {
	...
	$labels = array(
		...
		'not_found'             => __( 'No Peoples found', 'text_domain' ),
		'not_found_in_trash'    => __( 'No Peoples found in Trash', 'text_domain' ),
		'featured_image'        => __( 'Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
		'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
		'use_featured_image'    => __( 'Use as featured image', 'text_domain' ),
